...
urlpatterns = [
    ...
    path('order_summary/<int:order_id>/', views.cancel_and_print_order, name='order_summary'),
    path('generate_pdf/<int:order_id>/', views.generate_pdf, name='generate_pdf'),
    path('cancel_order/<int:order_id>/', views.cancel_and_print_order, name='cancel_order'),
